...
COLORS = ['blue', 'blurple', 'dark blue', 'dark gold', 'dark gray', 'dark magenta', 'dark orange',
                  'dark purple', 'dark red', 'dark teal', 'fuschia', 'gold', 'green', 'light gray', 'magenta',
                  'nitro pink', 'orange', 'purple', 'red', 'teal', 'yellow']
